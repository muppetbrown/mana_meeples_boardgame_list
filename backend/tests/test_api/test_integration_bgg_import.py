...
class TestBGGImportFlowIntegration:
    ...
    def test_import_new_game_complete_flow(self, test_client, test_db):
    ...
    def test_import_existing_game_without_force(self, test_client, test_db, sample_game):
    ...
    def test_import_existing_game_with_force(self, test_client, test_db, sample_game):
    ...
    def test_import_invalid_bgg_id(self, test_client):
    ...
    def test_import_without_authentication(self, test_client):
        """Should return 401 when not authenticated"""
        response = test_client.post('/api/admin/import/bgg?bgg_id=13')

        assert response.status_code == 401

    def test_import_with_network_error(self, test_client):
    ...
    def test_import_with_malformed_bgg_data(self, test_client):
    ...
    def test_import_persists_all_fields(self, test_client, test_db):
    ...
    def test_import_handles_null_optional_fields(self, test_client):
    ...
    def test_bulk_import_csv(self, test_client, test_db):
    ...
    def test_import_duplicate_detection(self, test_client, test_db, sample_game):
    ...
    def test_import_transaction_rollback_on_error(self, test_client, test_db):
        """Should rollback database transaction if import fails mid-process"""
        # This would require mocking database errors
        # Placeholder for future implementation
        pass

    def test_import_rate_limiting(self, test_client):
    ...
    def test_import_concurrent_requests(self, test_client):
    ...
    def test_import_updates_timestamp(self, test_client, test_db):
    ...
    def test_import_thumbnail_download_trigger(self, test_client):
    ...
    def test_import_special_characters_in_title(self, test_client):
    ...
    def test_import_large_designer_list(self, test_client):
    ...
    def test_import_returns_complete_game_object(self, test_client):
    ...
    def test_import_idempotency(self, test_client):
    ...
    def test_import_validates_required_fields(self, test_client):
    ...
    def test_import_preserves_manual_categorization(self, test_client, test_db, sample_game):
    ...
    def test_import_logs_activity(self, test_client):
    ...
    def test_import_sets_default_status(self, test_client):
    ...
    def test_import_bgg_api_retry_logic(self, test_client):
    ...
    def test_import_respects_bgg_rate_limits(self, test_client):
    ...
    def test_reimport_all_games_endpoint(self, test_client, test_db, sample_game):
    ...
    def test_import_error_provides_helpful_message(self, test_client):
